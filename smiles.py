...
smiles_dict = {"8":"OCC[C@@](O)(C)[C@H]([C@H](C)CC)C([O-])=O",
               "16": "OCCC(O)(C)C(C1=CN(CC2CC(F)(F)C2)N=N1)C([O-])=O",
               "17": "OCCC(O)(C)C(C1=CN(CCCO)N=N1)C([O-])=O",
               "18": "OCCC(O)(C)C(C1=CN(C2=CC=C(C(F)(F)F)C=C2)N=N1)C([O-])=O",
               "19": "OCCC(O)(C)C(C1=CN(C2=CC=C(C(C)=CC(O3)=O)C3=C2)N=N1)C([O-])=O",
               "20": "OCCC(O)(C)C(C1=CN(CCOC2C(O)C(O)C(O)C(CO)O2)N=N1)C([O-])=O",
               "21": "OCCC(O)(C)C(C1=CN(C2=C(F)C(F)=C(F)C(F)=C2F)N=N1)C([O-])=O",
               "22":"OCCC(O)(C)C(C1=CN(CC(O)(C)C)N=N1)C([O-])=O",
               "23":"OCCC(O)(C)C(C1=CN(C2=CC=C(Cl)C=C2O)N=N1)C([O-])=O",
               "24":"OCCC(O)(C)C(C1=CN(CCCF)N=N1)C([O-])=O",
               "25":"OCCC(O)(C)C(C1=CN(C2=NC=CC=N2)N=N1)C([O-])=O",
               "26":"OCCC(O)(C)C(/C=C/C1=CC=C(F)C=C1)C([O-])=O",
               "27":"OCC[C@@](O)(C)[C@H](C1=CN(C[C@H]2OCCOC2)N=N1)C([O-])=O"}

for name, smiles_str in smiles_dict.items():
    replyobj.status("Processing " + name)
